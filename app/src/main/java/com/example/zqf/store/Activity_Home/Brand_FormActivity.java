    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx51.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(Brand_FormActivity.this).setTitle("添加姓名").setView(x)
        ...
        tx54.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText x=new EditText(Brand_FormActivity.this);
                new AlertDialog.Builder(Brand_FormActivity.this).setTitle("添加QQ号").setView(x)
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        tx58.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText x=new EditText(Brand_FormActivity.this);
                new AlertDialog.Builder(Brand_FormActivity.this).setTitle("添加手机号").setView(x)
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        tx61.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText x=new EditText(Brand_FormActivity.this);
                new AlertDialog.Builder(Brand_FormActivity.this).setTitle("添加名称").setView(x)
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        tx65.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText x=new EditText(Brand_FormActivity.this);
                new AlertDialog.Builder(Brand_FormActivity.this).setTitle("添加描述").setView(x)
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        tx63.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final EditText x=new EditText(Brand_FormActivity.this);
                new AlertDialog.Builder(Brand_FormActivity.this).setTitle("添加价格").setView(x)
                        .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                builder=new android.app.AlertDialog.Builder(Brand_FormActivity.this);
        ...
        switch (requestCode) {
            ...
            case 3:
                if (data != null) {
                    ...
                    if (pic != null) {
                        saveBitmap(pic);
                        final BmobFile bmobFile0 = new BmobFile(new File(path));
                        good.setPicGood(bmobFile0);
